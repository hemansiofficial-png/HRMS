...
import { X, Key, Copy, RefreshCw, AlertTriangle } from 'lucide-react';
...
export function AdminResetPasswordModal({ user, onClose, onSuccess }: AdminResetPasswordModalProps) {
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                <p className="text-sm text-yellow-800">
                  <strong>Warning:</strong> This will reset the password for <strong>{user.email}</strong> to the default password.
                </p>
                {user.role && (
